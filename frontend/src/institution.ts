...
namespace PigeInstitution {
  export interface Identity {
    ...
    font_family:string; logo_url:string; font_configured:boolean; version:number;
  }
  export const state = Vue.reactive<Identity>({display_name:'Sua escola',short_name:'Escola',primary_color:'#006D77',secondary_color:'#0D1B2A',font_family:'system',logo_url:'',font_configured:false,version:1});
  export function apply(value:Identity):void {
    ...
    if(theme)theme.href='/api/v1/institution/theme.css?v='+value.version;
