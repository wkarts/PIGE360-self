...
CREATE TABLE persons (
	...
	CONSTRAINT fk_persons_photo_file_id_files FOREIGN KEY(photo_file_id) REFERENCES files (id),
...
CREATE TABLE users (
	...
	CONSTRAINT ck_users_valid_role CHECK (role IN ('admin','direction','coordination','secretary','teacher','student','guardian','viewer')),
	CONSTRAINT uq_users_email UNIQUE (email),
	CONSTRAINT fk_users_person_id_persons FOREIGN KEY(person_id) REFERENCES persons (id)
)
;
...
CREATE TABLE employee_profiles (
	...
	work_schedule VARCHAR(160) NOT NULL,
	supervisor_name VARCHAR(180) NOT NULL,
	...
	CONSTRAINT fk_employee_profiles_person_id_persons FOREIGN KEY(person_id) REFERENCES persons (id),
	CONSTRAINT fk_employee_profiles_school_id_schools FOREIGN KEY(school_id) REFERENCES schools (id)
)
;
...
CREATE TABLE person_type_links (
	...
	version INTEGER NOT NULL,
	school_id VARCHAR(36) NOT NULL,
	CONSTRAINT pk_person_type_links PRIMARY KEY (id),
	CONSTRAINT uq_person_type_links_school_id UNIQUE (school_id, person_id, type_code),
	CONSTRAINT fk_person_type_links_person_id_persons FOREIGN KEY(person_id) REFERENCES persons (id),
	CONSTRAINT fk_person_type_links_school_id_schools FOREIGN KEY(school_id) REFERENCES schools (id)
)
;
...
CREATE TABLE students (
	...
	sus_card VARCHAR(32) NOT NULL,
	inep_code VARCHAR(32) NOT NULL,
	health_plan VARCHAR(120) NOT NULL,
	allergies TEXT NOT NULL,
	medications TEXT NOT NULL,
	health_notes TEXT NOT NULL,
	special_needs TEXT NOT NULL,
	authorized_transport VARCHAR(120) NOT NULL,
...
CREATE TABLE teacher_profiles (
	...
	professional_registration VARCHAR(80) NOT NULL,
	employment_type VARCHAR(32) NOT NULL,
	employment_status VARCHAR(24) NOT NULL,
	admission_date DATE,
	termination_date DATE,
	inep_code VARCHAR(32) NOT NULL,
	education_institution VARCHAR(180) NOT NULL,
	degree_course VARCHAR(180) NOT NULL,
	...
	CONSTRAINT uq_teacher_profiles_person_id UNIQUE (person_id),
	CONSTRAINT fk_teacher_profiles_person_id_persons FOREIGN KEY(person_id) REFERENCES persons (id),
	CONSTRAINT fk_teacher_profiles_school_id_schools FOREIGN KEY(school_id) REFERENCES schools (id)
)
;
...
CREATE TABLE enrollments (
	...
	entry_reason VARCHAR(1000) NOT NULL,
...
CREATE TABLE teacher_assignments (
	teacher_user_id VARCHAR(36),
	teacher_person_id VARCHAR(36),
	class_group_id VARCHAR(36) NOT NULL,
	academic_year_id VARCHAR(36) NOT NULL,
	...
	CONSTRAINT uq_teacher_assignments_school_id UNIQUE (school_id, teacher_user_id, class_group_id, academic_year_id, subject_name),
	CONSTRAINT fk_teacher_assignments_teacher_user_id_users FOREIGN KEY(teacher_user_id) REFERENCES users (id),
	CONSTRAINT fk_teacher_assignments_teacher_person_id_persons FOREIGN KEY(teacher_person_id) REFERENCES persons (id),
	CONSTRAINT fk_teacher_assignments_class_group_id_class_groups FOREIGN KEY(class_group_id) REFERENCES class_groups (id),
	CONSTRAINT fk_teacher_assignments_academic_year_id_academic_years FOREIGN KEY(academic_year_id) REFERENCES academic_years (id),
	CONSTRAINT fk_teacher_assignments_school_id_schools FOREIGN KEY(school_id) REFERENCES schools (id)
)
;
